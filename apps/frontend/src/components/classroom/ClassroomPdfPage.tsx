...
export function ClassroomPdfPage({
  ...
  useEffect(() => {
    ...
    const handleKeyDown = (event: KeyboardEvent) => {
      ...
      // Falling back to the hovered stroke covers pen and marker strokes, which are never
      // "selected" in the shape/text sense -- pointing at one and pressing Delete removes it.
      const singleId = selectedShapeId ?? selectedTextId ?? hoveredStrokeId;
      if (singleId) {
        event.preventDefault();
