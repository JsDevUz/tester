...
const OPTIONS: Option[] = [
  {
    ...
    description: "Butun darsni ovoz bilan yozadi — keyinroq boshidan oxirigacha, chizmalar bosqichma-bosqich qayta ijro etilib, tomosha qilish mumkin.",
  },
  {
    mode: "boardAudio",
    icon: Mic,
    label: "Faqat chizma (ovozli)",
    description: "Dars ovozi yoziladi, lekin faqat taxtaning ENG OXIRGI holati saqlanadi — bosqichma-bosqich qayta ijro bo'lmaydi, faqat yakuniy chizma + ovoz saqlanadi.",
  },
  {
    mode: "boardSilent",
    icon: MicOff,
    label: "Faqat chizma (ovozsiz)",
    description: "Ovoz umuman yozilmaydi — faqat taxtaning eng oxirgi holati (chizmalar) saqlanadi.",
  },
];
