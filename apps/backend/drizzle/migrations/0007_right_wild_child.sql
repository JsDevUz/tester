...
--> statement-breakpoint
ALTER TABLE "folders" DROP CONSTRAINT "folders_admin_id_admins_id_fk";
--> statement-breakpoint
ALTER TABLE "tests" DROP CONSTRAINT "tests_admin_id_admins_id_fk";
--> statement-breakpoint
ALTER TABLE "questions" ADD COLUMN "image_url" text;--> statement-breakpoint
ALTER TABLE "questions" ADD COLUMN "audio_url" text;--> statement-breakpoint
