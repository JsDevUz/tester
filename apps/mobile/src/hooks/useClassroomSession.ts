      ...
      socket.emit(
        ...
        (res: {ok: boolean; code?: string; state?: CsSnapshot}) => {
          ...
          setState({
            ...
            strokesByPage: snap.strokesByMode?.[snap.leftBoardMode ?? snap.boardMode ?? 'pdf'] ?? snap.strokesByPage ?? {},
            rightStrokesByPage: snap.strokesByMode?.[snap.rightBoardMode ?? snap.boardMode ?? 'pdf'] ?? snap.rightStrokesByPage ?? {},
